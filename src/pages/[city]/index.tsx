...
export const getServerSideProps: GetServerSideProps<IWeatherSuccessRes> = async (context) => {
    ...
    if (context.params?.city) {
        ...
        const w = await getWeather({
            lang: context.req.headers['accept-language'] || "pt-br", // get browser language from headers. default value is pt-br
...
export default function WeatherPage(props: IWeatherSuccessRes) {
    ...
    return (
        <>
            <Head>
                <title>{props.city.charAt(0).toUpperCase() + props.city.slice(1)} Clima</title>
